...
<div id="payment" class="grid_20">
	{if $PaymentUrl}
		{if $useIframe}
			...
			<center>
				<iframe style="width:100%; max-width:310px" name="payment_frame" id="payment_frame"  frameborder="0" border="0" src="{$PaymentUrl}" style="width: 450px; border: 0px solid #000;"></>
			</center>
